...
{
    public class QuadrupleAttackState<T> : IState where T : EnemyController
    {
        ...
        public QuadrupleAttackState(GenericStateMachine<T> stateMachine) => this.stateMachine = stateMachine;
